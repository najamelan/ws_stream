...
// This is a shameless plug from the tokio-serde-cbor crate, with literally just changed the import
// for Encoder/Decoder to futures-codec instead of tokio-io. And it automagically works!
